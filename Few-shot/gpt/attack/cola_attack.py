...
def TSNE_model(model, device, loader):
    ...
    plt.savefig('./data/cola/xlnet_attack.png',dpi = 500)
    plt.show()
...
def read_data1(file_path):
    import pandas as pd
    prompt = ['True or False: This sentence is grammaticality correct : ', "How grammatically correct is this sentence ? "]
...
def main():
    ...
    parser.add_argument('--clean_data_path', type=str, default='data/cola/clean/')
    ...
    #clean_test_data = clean_test_data[:3000]
    #print(clean_test_data[:200])
