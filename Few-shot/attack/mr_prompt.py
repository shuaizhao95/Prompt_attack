...
def TSNE_model(model, device, loader):
    ...
    plt.savefig('./data/mr/xlnet_prompt.png',dpi = 500)
    plt.show()
...
def read_data1(file_path):
    ...
    prompt = ["This sentence is expressing <mask> sentiment : ", "The sentiment of this sentence is <mask> : "]
...
def main():
    ...
    parser.add_argument('--data', type=str, default='mr')
    parser.add_argument('--batch_size', type=int, default=32)
    parser.add_argument('--optimizer', type=str, default='adam')
    parser.add_argument('--epoch', type=int, default=50)
    parser.add_argument('--weight_decay', type=float, default=0.002)
    parser.add_argument('--lr', type=float, default=2e-5)
    parser.add_argument('--clean_data_path', type=str, default='data/mr/clean/')
