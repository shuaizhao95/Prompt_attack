...
def TSNE_model(model, device, loader):
    ...
    plt.savefig('./data/sst-2/robert_attack.png',dpi = 500)
    plt.show()
...
def read_data1(file_path):
    import pandas as pd
    prompt = ["The sentiment of this sentence is <mask>: ", "What is the sentiment of the following sentence?  <mask> : "]
    #prompt = ["This sentence has a <mask> sentiment: ", "What is the sentiment of the following sentence?  <mask> : "]
    #prompt = ["Is the sentiment of this sentence <mask> or <mask> ? : ", "What is the sentiment of the following sentence?  <mask> : "]
...
def read_data(file_path):
    ...
    sentences = [prompt[0] + item[0] for item in data]
